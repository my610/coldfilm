<template>
  <div>
    <div class="row">
      ...
      <!--<div class="col-md-4">-->
        <!--<p>-->
          <!--<small>Please select a movie from the list to continue.</small>-->
        <!--</p>-->
      <!--</div>-->
      <div class="col-md-9 col-sm-7 col-xs-12">
        <small><p class="text-info pull-right">Total films: {{ totalItems }}</p></small>
      </div>
    </div><!-- .row -->
    ...
    <div class="row">
      <div class="col-md-3">
        ...
        <!--<transition name="fade" mode="out-in">-->
          <!--<ul id="films" v-if="films.length > 0">-->
            <!--<li v-for="film in films" :key="film.id">-->
              <!--<a href="#" @click="showDetails(film.id)">{{ film.title }}</a>-->
            <!--</li>-->
          <!--</ul>-->
          <!--<p v-else class="text-center">Нет данных для отображения...</p>-->
        <!--</transition>-->
